<div>
    <div class="d-flex justify-content-between align-items-right mb-4 ml-auto">
                ...
                <tr>
                    ...
                    <td class="border-bottom-0">
                        <button type="button" class="btn btn-primary" data-toggle="modal"
                            data-target="#imageModal{{ $donation->id }}">
                            View Image
                        </button>
                        <div class="modal fade" id="imageModal{{ $donation->id }}" tabindex="-1" role="dialog"
                            aria-labelledby="imageModalLabel{{ $donation->id }}" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <img src="{{ asset($donation->link) }}" alt="Donation Image"
                                            style="max-width: 100%;">
                                    </div>
                                </div>
                            </div>
                        ...
                        <form action="{{ route('donations.updateStatus', $donation->id) }}" method="POST">
                            ...
                            <div class="btn-group mr-2" role="group"
                                ...
                                @if ($donation->status === 'belum dikonfirmasi')
                                    <button type="submit" name="new_status" value="disetujui"
                                        class="btn btn-success mr-2">
                                        Setujui
                                    </button>
                                    <button type="submit" name="new_status" value="ditolak"
