        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
                  ...
                  <table class="table text-nowrap mb-0 align-middle">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="border-bottom-0">
                          <button type="button" class="btn btn-primary mr-2" data-toggle="modal" data-target="#editModal" onclick="return confirm('Apakah Anda yakin ingin mengedit?')">
                            Edit
                          </button>
                          <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#hapusModal" onclick="return confirm('Apakah Anda yakin ingin menghapus?')">
                            Hapus
                          </button>
                        </td>
                      </tr>
              ...
              <a class="btn btn-success" href="{{route('volunteers.create')}}" onclick="return confirm('Apakah Anda yakin ingin menambah?')"><i class="fa fa-plus"></i> Tambah Volunteer</a>
